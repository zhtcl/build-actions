...
# 后台IP设置
export Ipv4_ipaddr="192.168.10.2"            # 修改openwrt后台地址(填0为关闭)
...
export OpenClash_Core="2"                   # 增加OpenClash时,把核心下载好,(填1为下载smart单核,填2为下载smart/meta双核,填0为不需要核心)
...
export amlogic_model="s922x"
export amlogic_kernel="6.12_6.6"
